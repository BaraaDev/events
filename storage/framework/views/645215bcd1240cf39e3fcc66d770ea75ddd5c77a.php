...
<link id="color" rel="stylesheet" href="<?php echo e(asset('admin/css/color-1.css')); ?>" media="screen">
<!-- Responsive css-->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin/css/responsive.css')); ?>">
<?php echo \Livewire\Livewire::styles(); ?>

<?php /**PATH E:\laragon\www\event\resources\views/layouts/admin/partials/css.blade.php ENDPATH**/ ?>