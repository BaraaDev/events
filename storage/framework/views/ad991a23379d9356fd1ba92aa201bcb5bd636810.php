                                ...
                                <?php else: ?>
                                    <div class="crumina-module crumina-heading align-center">
                                        <div class="heading-text"> <?php echo e(__('website/event.to_add')); ?>
                                            ...
                                            <a href="<?php echo e(route('register')); ?>" style="color: rgb(17, 17, 187); font-weight: bold;"><?php echo e(__('website/event.register')); ?></a> <?php echo e(__('website/event.or')); ?>

                                            <a href="<?php echo e(route('login')); ?>" style="color: rgb(17, 17, 187); font-weight: bold;"><?php echo e(__('website/event.log_in')); ?></a>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <aside aria-label="sidebar" class="sidebar sidebar-right">
                            ...
                            <aside class="widget w-tags">
                                <h5 class="widget-title"><?php echo e(__('website/event.tags')); ?></h5>
                                <ul class="tags-list">
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <div class="alert alert-danger" role="alert"><?php echo e(__('website/event.no_tags')); ?></div>
                                    <?php endif; ?>
                                </ul>
                            </aside>
                        </aside>
