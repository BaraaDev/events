...
<?php $__env->startSection('title'); ?> <?php echo e(__('admin/city.edit')); ?> (<?php echo e($model->name); ?>) <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('breadcrumb_title'); ?>
            <h3><?php echo e(__('admin/city.edit')); ?> (<?php echo e($model->name); ?>)</h3>
        <?php $__env->endSlot(); ?>
        <li class="breadcrumb-item"><a href="<?php echo e(route('cities.index')); ?>"><?php echo e(__('admin/city.cities')); ?></a> </li>
        <li class="breadcrumb-item active"><?php echo e(__('admin/city.edit')); ?> (<?php echo e($model->name); ?>)</li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="tab-content " id="pills-tabContent">
                    <form action="<?php echo e(route('cities.update',$model->id)); ?>" method="post" id="alert-form">
                        <?php echo csrf_field(); ?>
                        <?php echo e(method_field('put')); ?>

                        <?php echo $__env->make('dashboard.cities.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <button class="btn btn-success mt-4 d-block me-auto" type="submit"><?php echo e(__('admin/city.update')); ?></button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\events\resources\views/dashboard/cities/edit.blade.php ENDPATH**/ ?>