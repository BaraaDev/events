<?php $__env->startSection('title'); ?> <?php echo e(__('admin/service.edit')); ?> (<?php echo e($model->name); ?>) <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

<?php $__env->startComponent('components.breadcrumb'); ?>
<?php $__env->slot('breadcrumb_title'); ?>
<h3><?php echo e(__('admin/service.edit')); ?> (<?php echo e($model->name); ?>)</h3>
<?php $__env->endSlot(); ?>
<li class="breadcrumb-item"><a href="<?php echo e(route('services.index')); ?>"><?php echo e(__('admin/service.services')); ?></a> </li>
<li class="breadcrumb-item active"><?php echo e(__('admin/service.edit')); ?> (<?php echo e($model->name); ?>)</li>
<?php $__env->slot('bookmark'); ?>
    <a href="<?php echo e(route('services.create')); ?>" class="btn btn-pill btn-air-success btn-success-gradien" type="button" title="<?php echo e(__('admin/service.create')); ?>"><?php echo e(__('admin/service.create')); ?></a>
<?php $__env->endSlot(); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="tab-content " id="pills-tabContent">
                <form action="<?php echo e(route('services.update',$model->id)); ?>" method="post" id="alert-form">
                    <?php echo csrf_field(); ?>
                    <?php echo e(method_field('put')); ?>

                    <?php echo $__env->make('dashboard.services.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <button class="btn btn-success mt-4 d-block me-auto" type="submit"><?php echo e(__('admin/service.update')); ?></button>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\event\resources\views/dashboard/services/edit.blade.php ENDPATH**/ ?>