        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="tab-content " id="pills-tabContent">
                    <form action="<?php echo e(route('events.update',$model->id)); ?>" method="post" id="alert-form">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\events\resources\views/dashboard/events/edit.blade.php ENDPATH**/ ?>