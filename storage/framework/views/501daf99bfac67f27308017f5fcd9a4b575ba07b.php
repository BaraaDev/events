...
<?php $model = app('App\Models\Tag'); ?>

<?php $__env->startSection('title'); ?> <?php echo e(__('admin/tag.create')); ?> <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>

    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('breadcrumb_title'); ?>
            <h3><?php echo e(__('admin/tag.create')); ?></h3>
        <?php $__env->endSlot(); ?>
        <li class="breadcrumb-item"><a href="<?php echo e(route('tags.index')); ?>"><?php echo e(__('admin/tag.tags')); ?></a> </li>
        <li class="breadcrumb-item active"><?php echo e(__('admin/tag.create')); ?></li>
    ...
    <div class="col-sm-12 col-xl-6 xl-100">
        <div class="card">
            <div class="card-header pb-0">
                <h5><?php echo e(__('admin/tag.addTag')); ?></h5>
            </div>
            <div class="card-body">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <form action="<?php echo e(route('tags.store')); ?>" method="post" id="alert-form">
                        <?php echo csrf_field(); ?>
                        <?php echo $__env->make('dashboard.tags.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <button class="btn btn-success mt-4 d-block me-auto" type="submit"><?php echo e(__('admin/tag.add_new')); ?></button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\events\resources\views/dashboard/tags/create.blade.php ENDPATH**/ ?>