<div class="tab-pane fade mt-4 <?php if(LaravelLocalization::getCurrentLocale() == 'ar'): ?> show active <?php endif; ?>" id="ar" role="tabpanel" aria-labelledby="ar-tab">
    <div class="form-group row">
        <label class="form-label col-lg-3"><?php echo e(__('admin/event.event')); ?> <span class="text-danger">*</span> </label>
        <div class="col-lg-9">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group row">
        <label class="form-label col-lg-3"><?php echo e(__('admin/home.description')); ?> <span class="text-danger">*</span></label>
        <div class="col-lg-9">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group row">
        <label class="form-label col-lg-3"><?php echo e(__('admin/event.location')); ?> <span class="text-danger">*</span> </label>
        <div class="col-lg-9">
            <input class="form-control <?php $__errorArgs = ['location_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" name="description_en"><?php echo e(Request::old('description_en') ? Request::old('description_en') : $model->getTranslation('description','ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group row">
        <label class="form-label col-lg-3"><?php echo e(__('admin/event.location')); ?> <span class="text-danger">*</span> </label>
        <div class="col-lg-9">
            <input class="form-control <?php $__errorArgs = ['location_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" type="text" name="description_fr"><?php echo e(Request::old('description_fr') ? Request::old('description_fr') : $model->getTranslation('description','ar')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group row">
        <label class="form-label col-lg-3"><?php echo e(__('admin/event.location')); ?> <span class="text-danger">*</span> </label>
        <div class="col-lg-9">
            <input class="form-control <?php $__errorArgs = ['location_fr'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/event.time')); ?> <span class="text-danger">*</span> </label>
    <div class="col-lg-9">
        <input class="form-control <?php $__errorArgs = ['time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(Request::old('time') ? Request::old('time') : $model->time); ?>" type="time" name="time" autocomplete="off">
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/event.date')); ?> <span class="text-danger">*</span> </label>
    <div class="col-lg-9">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(Request::old('date') ? Request::old('date') : $model->date); ?>" type="date" name="date" autocomplete="off">
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/event.budget')); ?> <span class="text-danger">*</span> </label>
    <div class="col-lg-9">
        <input class="form-control <?php $__errorArgs = ['budget'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(Request::old('budget') ? Request::old('budget') : $model->budget); ?>" type="number" name="budget" placeholder="<?php echo e(__('admin/event.enter_budget')); ?>" autocomplete="off">
...
<div class="form-group row">
    ...
    <div class="col-lg-9">
        ...
        <?php echo Form::select('user_id',$user->type('customer')->pluck('name','id'),Request::old('user_id') ? Request::old('user_id') : $model->user_id,[
            'placeholder' => __('admin/home.select'),
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/country.country')); ?> <span class="text-danger">*</span></label>
    <div class="col-lg-9">
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/governorate.Governorate')); ?> <span class="text-danger">*</span></label>
    <div class="col-lg-9">
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/city.city')); ?> <span class="text-danger">*</span></label>
    <div class="col-lg-9">
...
<div class="form-group row">
    <label class="form-label col-lg-3"><?php echo e(__('admin/tag.tags')); ?> <span class="text-danger">*</span></label>
    <div class="col-lg-9">
        <?php $tag = app('App\Models\Tag'); ?>
        <?php echo Form::select('tag_id[]',$tag->pluck('name','id'),$model->tags->pluck('id')->all(),[
            'placeholder' => __('admin/home.select'),
...
<?php /**PATH E:\laragon\www\events\resources\views/dashboard/events/form.blade.php ENDPATH**/ ?>