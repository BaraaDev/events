                                        ...
                                        <form class="contact-form" action="<?php echo e(route('comment.add')); ?>" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                    <input required name="value" placeholder="<?php echo e(__('website/event.offer_value')); ?>" type="number" autocomplete="off" onkeyup="$('#gain_value').val($(this).val()- ($(this).val()*5/100) );$('.gain_value').text($(this).val()- ($(this).val()*15/100) );">
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<?php echo $__env->make('layouts.website.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\event\resources\views/website/events/show.blade.php ENDPATH**/ ?>