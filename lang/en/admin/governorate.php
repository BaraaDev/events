...
return [
    ...
    'DescriptionGovernorate_delete'     => 'All deleted governorates. If you want to create and add new sections, you must click the (Create New Governorate) button at the top of the page, and if you want to restore any section, press (Restore) next to each governorate.',
];
