                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
                                        <img src="{{asset('website/img/slides5-modified.png')}}" width="200" height="600" alt="slider"> <!--original: slides1.png-->
                                        <img src="{{asset('website/img/slides7.png')}}" width="300" height="600" alt="slider"> <!--original: slides1.png-->
                                    </div>
                                </div>
                            ...
                            <div class="row table-cell">
                                ...
                                <div class="col-lg-6 col-sm-12 table-cell">
                                    <div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="200">
                                        <img src="{{asset('website/img/events_image.png')}}" alt="slider"> <!--original: slides2.png-->
                                    </div>
                                </div>
