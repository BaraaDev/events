                    ...
                    <div class="crumina-module crumina-heading align-center">
                        @auth
                            ...
                            @elseif(auth()->user()->user_type == 'dashboard')
                                ...
                                <h5 class="heading-title"><a href="{{route('categories.create')}}" style="color: rgb(17, 17, 187);" onmouseover="this.style.color='purple'" onmouseout="this.style.color='rgb(17, 17, 187)'">Click Here</a> to Add a New Service!</h5>
                            @endif
                        @endauth
                        @guest
                            <h4 class="heading-title">Services Categories</h4>
                            ...
                            <div class="swiper-slide">
                                <div class="crumina-module crumina-info-box info-box--time-line">
                                    ...
                                    <div class="info-box-content">
                                        <h6 class="timeline-year c-secondary" style="color:{{$service->color}};"><a href="{{route('event.category',$service->id)}}" onmouseover="this.style.color='grey'" onmouseout="this.style.color=''">{{$service->name}}</a></h6> <!-- headline-text-color from DB for icon -->
