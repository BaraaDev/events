                                ...
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('sliders.edit',$slider->id)}}" class="btn btn-primary btn-xs" type="button" title="{{__('admin/home.edit')." ($slider->title)"}}"><li class="icon-pencil"></li> {{__('admin/home.edit')}}</a>
                                            {!! Form::close() !!}
                                        </td>
                                    </tr>
