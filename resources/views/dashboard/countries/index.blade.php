                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center">{{__('admin/country.create_history')}}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {!! Form::open([
                                            'action' => ['App\Http\Controllers\Admin\CountryController@destroy',$country->id],
                                            'method' => 'delete'
                                            ])!!}
                                            ...
                                            <a href="{{route('countries.edit',$country->id)}}" class="btn btn-primary btn-xs" type="button" title="{{__('admin/home.edit')." ($country->name)"}}">
