                    ...
                    <div class="teammembers-wrap">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/teammember1.png')}}" alt="team member">
                                </div>
                            ...
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/teammember2.png')}}" alt="team member">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/teammember3.png')}}" alt="team member">
                                </div>
