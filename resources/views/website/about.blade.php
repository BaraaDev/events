                ...
                <div class="row">
                    <div class="crumina-module crumina-module-img-bottom">
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <img class="img-bottom" src="{{asset('website/img/man2.png')}}" alt="man">
                        </div>
                                                    ...
                                                    <div class="crumina-module crumina-testimonial-item testimonial-item-arrow">
                                                        <div class="author-info-wrap">
                                                            <div class="testimonial-img-author">
                                                                <img src="{{asset('website/img/author2.png')}}" alt="author">
                                                            </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="crumina-module crumina-testimonial-item testimonial-item-arrow">
                                                        <div class="author-info-wrap">
                                                            <div class="testimonial-img-author">
                                                                <img src="{{asset('website/img/author3.png')}}" alt="author">
                                                            </div>
                                                            <div class="author-info">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="col-lg-12 col-md-4 col-sm-12">
                                                    <div class="crumina-module crumina-testimonial-item testimonial-item-arrow">
                                                        <div class="author-info-wrap">
                                                            <div class="testimonial-img-author">
                                                                <img src="{{asset('website/img/author4.png')}}" alt="author">
                                                            </div>
                                                            <div class="author-info">
                    ...
                    <div class="teammembers-wrap">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="crumina-module crumina-teammembers-item" style="margin-bottom: 25%;">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/kareem.jpg')}}" alt="kareem team member" width="200" style="border-radius: 50px;">
                                </div>
                            ...
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/teammember2.png')}}" alt="rawan team member" width="200" style="border-radius: 50px;">
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/mustafa.jpeg')}}" alt="mustafa team member" width="200" style="border-radius: 50px;">
                                </div>
                            ...
                            <div class="crumina-module crumina-teammembers-item">
                                ...
                                <div class="teammembers-thumb">
                                    <img src="{{asset('website/img/teammember4.png')}}" alt="team member">
                                </div>
